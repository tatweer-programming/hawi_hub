...
import 'package:hawihub/src/modules/games/view/screens/all_players_screen.dart';
import 'package:hawihub/src/modules/games/view/screens/create_game_screen.dart';
import 'package:hawihub/src/modules/games/view/screens/game_screen.dart';
import 'package:hawihub/src/modules/games/view/screens/select_game_time_screen.dart';
    ...
    switch (settings.name) {
      ...
      case Routes.exploreBySport:
        Map<String, dynamic> arguments =
            settings.arguments as Map<String, dynamic>;
        return MaterialPageRoute(
            builder: (_) => ExploreBySportsScreen(
