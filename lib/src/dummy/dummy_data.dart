...
List<Game> dummyGames = [
  Game(
    ...
    endTime: DateTime.now().add(const Duration(days: 2, hours: 7)),
    deadline: DateTime.now().add(const Duration(days: 1, hours: 5)),
    sportId: 101,
    players: [
      const GamePlayer(id: 1, name: "Player 1", imageUrl: "", isHost: false),
      const GamePlayer(id: 1, name: "Player 1", imageUrl: "", isHost: false),
      const GamePlayer(id: 1, name: "Player 1", imageUrl: "", isHost: false),
    ],
    host: Host(
  ...
  Game(
    ...
    isPublic: false,
    startTime: DateTime.now().add(const Duration(days: 5, hours: 4)),
    endTime: DateTime.now().add(const Duration(days: 5, hours: 5, minutes: 30)),
    deadline: DateTime.now().add(const Duration(days: 4, hours: 4)),
    sportId: 102,
    players: [
      const GamePlayer(id: 1, name: "Player 1", imageUrl: "", isHost: false),
      const GamePlayer(id: 1, name: "Player 1", imageUrl: "", isHost: false),
...
List<Booking> dummyReservations = [
  Booking(
      reservationId: 1,
      placeId: 1,
      reservationPrice: 20,
      reservationStartTime: DateTime.now(),
      reservationEndTime: DateTime.now(),
      approvalStatus: 1,
      placeName: "place 1 place 1 place 1 place 1 place 1",
      placeAddress: "adress 1 adress 1 adress 1 adress 1 adress 1 ",
      placeImages: [""]),
  Booking(
      reservationId: 1,
      placeId: 1,
